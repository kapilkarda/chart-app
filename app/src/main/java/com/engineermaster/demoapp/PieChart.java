...
public class PieChart extends RoundChart {
	...
	protected void onDraw(Canvas canvas) {
		...
		Log.d("gopalvaluechk","Gopalsir piechart class");
		...
		Log.d("gopalvaluechk","Gopalsir piechart class2222");
	...
	protected void drawCircle(Canvas canvas) {
		...
		Log.d("piechart","piechart");


		Log.d("gopalvaluechk","Gopalsir piechart class33333");
	...
	protected void drawData(Canvas canvas) {
		...
		Log.d("gopalvaluechk","Gopalsir piechart class draw circle");
