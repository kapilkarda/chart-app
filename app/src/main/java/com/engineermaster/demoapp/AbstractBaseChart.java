...
public abstract class AbstractBaseChart extends View implements IChart {
	 ...
	 * </p>
	 */
//	public static final int DEFAULT_BORDER_COLOR = Color.RED;   //it can be display rectngle red border in graph,,,,,

	public static final int DEFAULT_BORDER_COLOR = Color.WHITE;   //it can be display rectngle red border in graph,,,,,
	...
	protected void drawBorder(Canvas canvas) {
		...
		position2 = new Point((int) (getWidth() / 2f), (int) (getHeight() / 2f));
		final int DEFAULT_LONGITUDE_LENGTH2 = 80;
		float longitudeLength2 = DEFAULT_LONGITUDE_LENGTH2;


		int backGroundColor = Color.BLACK;
		float max=10;
		float radiusLength =  10/max * longitudeLength2;
	...
	//	canvas.drawCircle(246f, 437f, 222, paint);
