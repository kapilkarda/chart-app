...
public class RoseChart extends PieChart {
    ...
    protected void drawData(Canvas canvas) {
        ...
        Log.d("gopalvaluechk","Gopalsir piechart inRose chart class");

        if (null != data) {

            Log.d("gopalvaluechk","data"+data);
            // data's value max
    //        float max = 0;
            ...
            Log.d("gopalvaluechk","maximum"+max);
          ...
          //  mPaintFillCircleBackgroud.setColor(Color.LTGRAY);
            mPaintFillCircleBackgroud.setColor(Color.parseColor("#f4f6f7"));
            ...
            mPaintFont.setColor(Color.parseColor("#000000"));
            mPaintFont.setTextSize(Color.parseColor("#000000"));
            mPaintFont.setAntiAlias(true);

      /*      canvas.drawText("Life is one indivisible whole ! How will trip if your Wheel of Life will\n" +
                    "one of the real wheels of your life Vehicle ?\n" +
                    "Look carefully at the areas where you would like to increase your level of satisfaction ?\n" +
                    "Think about what level of individual areas will be satisfactory for you ? What are the\n" +
                    "relationships and dependencies between different areas ? What impact will have to increase the level\n" +
                    "satisfaction of one of the areas on the other ?", position2.x, position2.y, mPaintFont);

            canvas.drawText("wheels of your life Vehicle Look carefully at the areas where you would like to increase your level of satisfaction ",position3.x,position3.y,mPaintFont);
*/
...
//            }
        ...
        Log.d("gopalvaluechk","Gopalsir_piechart_inRose_chart_class");
    }
}
